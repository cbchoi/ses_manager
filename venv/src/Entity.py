...
class StructuralEntity(Entity):
    ...
    def serialize_core_attribute(self):
        ...
        json_obj["entities"] = self.core_attribute.retrive_entities()
        json_obj["input_ports"] = self.core_attribute.retrive_input_ports()
        json_obj["output_ports"] = self.core_attribute.retrive_output_ports()
        json_obj["external_input"] = self.core_attribute.retrive_external_input_coupling()
        json_obj["external_output"] = self.core_attribute.retrive_external_output_coupling()
        json_obj["internal"] = self.core_attribute.retrive_internal_coupling()
        to_list.append(json_obj)
        return to_list

    def deserialize_core_attribute(self, json):
        pass
